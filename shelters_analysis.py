...
col_intro_text, col_intro_img = st.columns([1, 1], vertical_alignment="center")
...
Над проєктом працювали студентки Київської школи економіки Марія Кобичева, Дарина Кальченко, Діана Алдошина, Лілія Червонецька, Валерія Міхайлишина у межах курсу «Дані і суспільство».
...
st.markdown(
    ...
    Ми взяли фото з самої Мапи укриттів (https://shelters.dsns.gov.ua/), щоб проілюструвати кожен тип та наскільки різними є навіть укриття, що належать до одного типу. В цьому ми вбачаємо один з найбільших мінусів поточного представлення інформації про укриття - **сховища дуже різного стану часто позначені однією категорією**.
    """
)
...
SHELTER_TYPES = [
    ...
    },
    {
        ...
        "example": "В Києві - лише станції метро.",
    },
    {
...
st.caption("Київська школа економіки · липень 2026")
